...
{
    [Tooltip("Load next scene when last page")]
    public int nextSceneIndex;
    [Tooltip("Load prev scene when user at first page")]
    ...
    public void loadNextScene()
    {
        ...
        {
            SceneChanger.nextScene(nextSceneIndex);
        }
    }
    ...
    public void loadPrevScene()
    {
        ...
        if (_currentPage == 0)
        {
            SceneChanger.nextScene(prevSceneIndex);
        }
    }
    //------------------------------------------------------------------------
